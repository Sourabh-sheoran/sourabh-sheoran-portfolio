...
export function Navbar({
  ...
  return (
    <header className={className}>
      {/* Brand / Name Link with Custom Portfolio Monogram Logo */}
      <a
        href="#"
        onClick={(e) => {
          e.preventDefault();
        ...
        className="group flex items-center gap-3 font-semibold tracking-[0.14em] text-white text-sm hover:opacity-90 transition-all duration-200"
      >
        <SourabhLogo size={30} />
        <span className="group-hover:tracking-[0.16em] transition-all duration-200">
          SOURABH SHEORAN
        </span>
      </a>
      ...
      <div className="hidden md:flex items-center gap-7 lg:gap-10">
        ...
        {/* Social Icons with real user URLs */}
        ...
        <button
          ...
          className="flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-white/20 hover:border-white/50 bg-white/[0.04] hover:bg-white/10 text-xs font-medium text-white transition-all duration-200"
        >
